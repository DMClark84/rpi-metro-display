...
def main():
    ...
    station_code = Array(ctypes.c_char, sys.argv[3].encode('UTF-8'))
    direction = Array(ctypes.c_char, sys.argv[4].encode('UTF-8'))
    lines_file = Array(ctypes.c_char, sys.argv[6].encode('UTF-8'))
    stations_file = Array(ctypes.c_char, sys.argv[7].encode('UTF-8'))
